...
date: '2023-02-21'
image: "/ts.svg"
description: "A discusion on statically vs dynamically typed languages."
---

<h2 id="title"> Me when using a dynamically typed language</h2>
<div id="title">
...
<h2 id="What-are"> What are Statically Typed and Dynamically Typed Languages?</h2>
<div id="What-are">
