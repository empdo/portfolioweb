  ...
  return (
    <div className="flex min-h-md w-full max-w-xs flex-col items-start rounded-xl bg-gradient-to-r from-slate-800 to-gray-800 p-5 shadow-2xl">
      <div className={"flex w-full flex-row items-center pb-6"}>
        ...
        <svg
          className={"h-7 pl-4 invert filter"}
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
      ...
      <p className={"text-xl text-gray-200"}>{props.description}</p>
      <span className={"flex-grow"} />
      <div className="bottom-0 flex flex-row gap-5">
        <p className={"text-xl text-violet-300"}>React</p>
        <p className={"text-xl text-violet-300"}>SQL</p>
        <p className={"text-xl text-violet-300"}>Something</p>
      </div>
    </div>
  );
};
    ...
    <div className={"flex flex-col content-center items-center"}>
      ...
      >
        ...
        <Project
          name="MindGame"
          url="j"
          description="some super cool project yeeyee"
        />
        <Project
          name="MindGame"
          url="j"
