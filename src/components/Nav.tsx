...
const Nav = () => {
  ...
  const handleAnimationFinish = (name: string) => {
    if (name == "fadeout") {
      ...
      setLinksAnimationState("");
      setIconAnimationState("");
    }

    console.log(name, showIcons);
  };
    ...
    >
      ...
      {showIcons ? (
        ...
        >
          ...
          >
            <svg
              className={"h-12 pl-8 invert filter"}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
            >
        ...
        <div
          className={
            (linksAnimationState == ""
              ? "animate-fadein"
              : linksAnimationState) + " flex flex-row items-center "
          }
          onAnimationEnd={(e) => handleAnimationFinish(e.animationName)}
        >
          <a className={"h-min"} href="">
          ...
          <a className={"h-min"} href="">
            <h2 className={"pl-4 text-3xl font-semibold text-white"}>Blog</h2>
          </a>
        </div>
      )}
      <div
        ...
        onClick={() => {
          showIcons
            ...
            : setLinksAnimationState("animate-fadeout");
        }}
      >
        <span
          className={
